...
public class PendingWriteQueueTest {
    ...
    public void testRemoveAndWriteAllReentrantWrite() {
        ...
        assertTrue(channel.finish());
        assertEquals(1L, java.util.Optional.ofNullable(channel.readOutbound()));
        assertEquals(2L, java.util.Optional.ofNullable(channel.readOutbound()));
        assertEquals(3L, java.util.Optional.ofNullable(channel.readOutbound()));
    }
